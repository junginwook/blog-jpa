...
import blog.study.top.querydslSelect필드로Entity사용시주의사항.oneToOne관계에서주테이블서브테이블.repository.CustomerRepository230317;
import blog.study.top.querydslSelect필드로Entity사용시주의사항.oneToOne관계에서주테이블서브테이블.repository.ShopRepository23031;
